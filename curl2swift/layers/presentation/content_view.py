...
UserInput = namedtuple("UserInput", ["request_name", "description", "curl"])
...
class ContentView(QWidget):
    ...
    def on_go_button_click(self):
        self.presenter.on_go_button_click(self.user_input)
    ...
    def on_change(self, view_model: WindowViewModel):
        ...
        self.info_label.setText(view_model.info_label_text)
    ...
    def __init__(self, screen_width):
        ...
        self.info_label.setMinimumHeight(250)
        ...
        self.left_half_layout.addWidget(self.info_label)
    ...
    def get_templates_tabs(self, screen_width):
        ...
        tabs.addTab(self.create_tab([self.request_template_text_edit]), "Request")
